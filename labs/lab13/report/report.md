...
В домашнем каталоге создайте подкаталог ~/work/os/lab_prog1. Создайте в нём файлы: calculate.h, calculate.c, main.c. Реализация функций калькулятора в файле calculate.h (рис. @fig:001). Интерфейсный файл calculate.h, описывающий формат вызова функциикалькулятора (рис. @fig:002). Основной файл main.c, реализующий интерфейс пользователя к калькулятору (рис. @fig:003).
...
Выполните компиляцию программы посредством gcc (рис. @fig:004).

![Выполните компиляцию](image/4.png){#fig:004 width=70%}

## Создайте Makefile 

Создайте Makefile со следующим содержанием (рис. @fig:005).

![Создайте Makefile ](image/6.png){#fig:005 width=70%}

## С помощью gdb выполните отладку программы calcul

1. Запустите отладчик GDB, загрузив в него программу для отладки (рис. @fig:006).

![gbd](image/7.png){#fig:006 width=70%}

2. Для запуска программы внутри отладчика введите команду run (рис. @fig:007).

![run](image/8.png){#fig:007 width=70%}

3. Для постраничного (по 9 строк) просмотра исходного код используйте команду list (рис. @fig:008).

![list](image/11.png){#fig:008 width=70%}

4. Для просмотра строк с 12 по 15 основного файла используйте list с параметрами (рис. @fig:009).

![list 12,15](image/12.png){#fig:009 width=70%}

5. Для просмотра определённых строк не основного файла используйте list с параметрами (рис. @fig:0010).

![list calculate.c:20,29](image/13.png){#fig:0010 width=70%}

6. Установите точку остановки в файле calculate.c на строке номер 21 (рис. @fig:0011).

![break 21](image/14.png){#fig:0011 width=70%}

7. Выведите информацию об имеющихся в проекте точка остановки (рис. @fig:0012).

![info breakpoints](image/15.png){#fig:0012 width=70%}

8. Запустите программу внутри отладчика и убедитесь, что программа остановится в момент прохождения точки остановки. Видим, что программа остановилась в момент прохождения точки остановки. Посмотрим, чему равно на этом этапе значение переменной Numeral. Далее, сравним с результатом вывода на экран после использования команды. И в конце, убедившись, что всё правильно, удалим точку остановки (рис. @fig:0013).

![run](image/17.png){#fig:0013 width=70%}

## С помощью утилиты splint попробуйте проанализировать коды файлов

1. С помощью утилиты splint анализирую кода файла calculate.c (рис. @fig:0014).

![splint](image/18.png){#fig:0014 width=70%}

2. С помощью утилиты splint анализирую кода файла main.c (рис. @fig:0015).
